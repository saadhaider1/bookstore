      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome back, Readers!</h1>
      ...
      <div className="hidden lg:block lg:w-1/2 bg-gradient-to-br from-lime-300 to-yellow-300 relative overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Discover your next favorite read</h2>
            <p className="text-lg text-gray-700">
              Join thousands of readers who have found their perfect book. Explore our vast collection, connect with fellow book lovers, and embark on literary adventures.
            </p>
          </div>
        </div>
