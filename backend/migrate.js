...
async function runMigration() {
  ...
  try {
    ...
    for (const author of authors) {
      await client.query(
        `INSERT INTO authors (name, avatar, bio) VALUES ($1, $2, $3)`,
    ...
    for (const category of categories) {
      await client.query(
        `INSERT INTO categories (name, count) VALUES ($1, $2) ON CONFLICT (name) DO NOTHING`,
    ...
    await client.query(
      ...
      ['John Doe', 'johndoe123@gmail.com', hashedPassword, '+1 234 567 8900', '123 Book Street, Reading City, RC 12345', 'Avid reader and book collector. Love exploring new genres and authors.']
    );
